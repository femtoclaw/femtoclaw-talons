...
This skill requires the GitHub CLI to be installed:
...
- **Permissions**: Review skill permissions before installing
...
- This skill uses the `gh` CLI for GitHub operations
